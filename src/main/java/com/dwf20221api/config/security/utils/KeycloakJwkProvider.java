...
public class KeycloakJwkProvider implements JwkProvider {
    ...
    public KeycloakJwkProvider(String jwkProviderUrl) {
        try {
            ...
            throw new IllegalArgumentException("URI inválida para los JWT", e);
        }
    ...
    public Jwk get(String keyId) throws JwkException {
        ...
        throw new SigningKeyNotFoundException("No se encontró ninguna llave en " + uri.toString() + " con una kid " + keyId, null);
    }
	...
	private List<Jwk> getAll() throws SigningKeyNotFoundException {
        ...
        try {
            ...
            throw new SigningKeyNotFoundException("Fracasa intento de parseo de JWT desde JSON proporcionado ", e);
        }
        return jwks;
    }
    ...
    private Map<String, Object> getJwks() throws SigningKeyNotFoundException {
        try {
            ...
            throw new NetworkException("No se pueden obtener JWT desde la uri proporcionada " + uri.toString(), e);
        }
    }
}
